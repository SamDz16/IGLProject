...
exports.enableDebugCapture = debugging_1.enableDebugCapture;
var stackTraces_2 = require("./stackTraces");
exports.stackWrapFunc = stackTraces_2.stackWrapFunc;
exports.stackWrapOwnMethods = stackTraces_2.stackWrapOwnMethods;
var logs_2 = require("./logs");
exports.logTypes = logs_2.logTypes;
...
async function createDriver(options = {}) {
    ...
    for (const logType of logs_1.getEnabledLogTypes()) {
    ...
    if (process.env.MOCHA_WEBDRIVER_MAX_CALLS) {
        ...
        executor.execute = serialize_calls_1.serializeCalls(executor.execute, count);
    }
    return newDriver;
}
...
async function cleanup(context) {
    ...
    const promises = [];
    if (exports.driver) {
        promises.push(exports.driver.quit());
    }
